...
class AppDelegate: NSObject, NSApplicationDelegate {
    ...
    var viewModels: [String: ClaudeViewModel] = [:] // UUID -> ClaudeViewModel
    var window: NSWindow?
    let vm: ClaudeViewModel = .init()
    ...
    private func createClaudeNotchWindow(for screen: NSScreen, with viewModel: ClaudeViewModel) -> NSWindow {
    ...
    func applicationDidFinishLaunching(_ notification: Notification) {
        ...
        if !Defaults[.showOnAllDisplays] {
            ...
            let window = createClaudeNotchWindow(
    ...
    @objc func adjustWindowPosition(changeAlpha: Bool = false) {
        if Defaults[.showOnAllDisplays] {
            ...
            for screen in NSScreen.screens {
                ...
                if windows[uuid] == nil {
                    let viewModel = ClaudeViewModel(screenUUID: uuid)
                    let window = createClaudeNotchWindow(for: screen, with: viewModel)
            ...
            if window == nil {
                window = createClaudeNotchWindow(for: selectedScreen, with: vm)
            }
