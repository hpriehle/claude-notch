...
@MainActor
class ClaudeViewCoordinator: ObservableObject {
    static let shared = ClaudeViewCoordinator()
    ...
    private init() {
        ...
        accessibilityObserver = NotificationCenter.default.addObserver(
            ...
            // HUD replacement accessibility handling can be added here if needed
        }
    ...
    private func scheduleSneakPeekHide(after duration: TimeInterval) {
        ...
        sneakPeekTask = Task { [weak self] in
            ...
            await MainActor.run {
                withAnimation {
                    self.toggleSneakPeek(status: false, type: .volume)
